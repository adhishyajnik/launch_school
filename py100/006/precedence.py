...
print(1 or 2 and 3)     # 1 or (2 and 3) = 1 or 3 = 1
print(0 or 2 and 3)     # 0 or (2 and 3) = 0 or 3 = 3
print(1 or 0 and 3)     # 1 or (0 and 3) = 1 or 0 = 1
print(1 or 2 and 0)     # 1 or (2 and 0) = 1 or 2 = 1
print(0 or 0 and 3)     # 0 or (0 and 3) = 0 or 0 = 0
print(0 or 2 and 0)     # 0 or (2 and 0) = 0 or 2 = 0
