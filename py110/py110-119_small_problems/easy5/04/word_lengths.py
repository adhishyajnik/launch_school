def word_lengths(word_string=""):
    return [f"{word} {len(word)}" for word in word_string.split()]
...
expected_result = ["baseball 8", "hot 3", "dogs 4", "and 3", "apple 5", "pie 3"]
print(word_lengths(words) == expected_result)  # True

words = "It ain't easy, is it?"
expected_result = ["It 2", "ain't 5", "easy, 5", "is 2", "it? 3"]
print(word_lengths(words) == expected_result)  # True
